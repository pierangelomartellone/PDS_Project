...
public:
    ...
    void retranslateUi(QWidget *FileExplorerWindow)
    {
        ...
        URILineEdit->setAccessibleDescription(QApplication::translate("FileExplorerWindow", "Your URI", nullptr));
#endif // QT_NO_ACCESSIBILITY
        URILineEdit->setPlaceholderText(QApplication::translate("FileExplorerWindow", "Paste your URI here", nullptr));
